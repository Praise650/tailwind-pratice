...
function MenuButton({ open, setAction }) {
  return (
    <button className="relative group focus:outline-none lg:hidden" onClick={() => setAction(!open)}>
      <div className="relative flex items-center justify-center rounded-full w-[30px] h-[30px] transform transition-all bg-slate-700 ring-0 ring-gray-300 hover:ring-8 focus:ring-4 ring-opacity-30 duration-200 shadow-md">
