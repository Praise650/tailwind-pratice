...
function AuthLeftSide({ navRight }) {
    ...
    return (
        <div className='bg-blue-700 px-11 py-10 w-[45%] flex flex-col justify-center max-lg:min-h-screen max-lg:min-w-full overflow-auto'>
            <div className='text-white mb-20'>
                <div className='inline-flex gap-2 items-center uppercase'>
                    <img alt='brand_logo' className='h-8' src='https://imgs.search.brave.com/UfU2B1IfoF337hpJj5HBSaLxrafVjdR-7osUmf2Z4ko/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9iY2Fz/c2V0Y2RuLmNvbS9h/c3NldHMvaW1hZ2Vz/L2ljb25zL2NvbW1v/bi1sYXJnZS9jb21t/b24tbGFyZ2UtYXJ0/d29yay5zdmc.svg' />
            ...
            <CarouselSlider />
            {
                <div className='flex flex-col mt-5 text-white w-full justify-center items-center lg:hidden'>
